...
public class Solver {
    ...
    public Solver(String line, Map<String, BigInteger> variables) {
    ...
    private void processOperator(String s) throws CalculatorException {
    ...
    private void process(String op) throws CalculatorException {
        BigInteger a;
        BigInteger b;
        try {
            a = numbers.pollLast();
            ...
            e.printStackTrace();
            throw new CalculatorException("One or both numbers could not be extracted " + op);
        }
